...
<nav >
    <ul class="nuestromenu">
        ...
        <li id="menu_cabecera_reg_con" style="display:none;"><a href="nuevocontrato.php">Nueva Oferta</a></li>
        <li id="menu_cabecera_datos" style="display:none"><a id="menu_cabecera_datos_text" href="#">Cambiar datos</a></li>
        <li id="menu_cabecera_cerrar_Session" style="display:none"><a href="servicios/cerrarSesion">Cerrar sesion</a></li>

        <?php
        if (isset($_SESSION['eClave'])) {
            echo "<script> document.getElementById('menu_cabecera_datos').style.display = 'initial'; </script>";
            echo "<script> document.getElementById('menu_cabecera_datos_text').href = 'cambiarDatosE.php'; </script>";
            ...
            echo "<script> document.getElementById('menu_cabecera_datos').style.display = 'initial'; </script>";
            echo "<script> document.getElementById('menu_cabecera_datos_text').href = 'cambiarDatosI.php'; </script>";
